...
public static class IEnumerableExtensions
{
        ...
        string fields)
    {
        ...
        var propertyListInfoList = new List<PropertyInfo>();
        ...
        if (string.IsNullOrWhiteSpace(fields))
        {
            ...
            propertyListInfoList.AddRange(propertyInfos);
        }
        else
        {
            ...
            foreach (var field in fieldsAfterSplit)
            {
                ...
                propertyListInfoList.Add(propertyInfo);
            }
        }
        ...
        foreach (TSource sourceObject in source)
        {
            ...
            foreach (var propertyInfo in propertyListInfoList)
            {
